...
\exercise{4}
\question{1}
Let us define a transitive Kripke model $\mathcal{M}$ and a formula $\varphi$, such that $\mathcal{M}^{\tilde\varphi}$ isn't transitive.

Let $\mathcal{M} = (W,R,V)$ such that $W=\{x,y_1,y_2,z\}$, $R = \{(x,y_1),(y_2,z)\}$ and $V(x)=p$, $V(y_1)=V(y_2)=q$ and $V(z)=r$. Let $\varphi=p\wedge q\wedge r$.

In  $\mathcal{M}^{\tilde\varphi}$, there are 3 worlds : $x^{\tilde\varphi}=\{x\}$, $y_1^{\tilde\varphi}=\{y_1,y_2\}$ and $z^{\tilde\varphi}=\{z\}$.

We also have $x^{\tilde\varphi}\ R^{\tilde\varphi}\ y_1^{\tilde\varphi}$ and $y_1^{\tilde\varphi}\ R^{\tilde\varphi}\ z^{\tilde\varphi}$, but we don't have $x^{\tilde\varphi}\ R^{\tilde\varphi}\ z^{\tilde\varphi}$, which means that $\mathcal{M}^{\tilde\varphi}$ isn't transitive.
